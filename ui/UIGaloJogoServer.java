...
* @author francisco
*/
public class UIGaloJogoServer implements ActionListener {

  JFrame window = new JFrame("Jogo do Galo - Servidor");
  ...
  */
  public UIGaloJogoServer(GameController controlador) {
   ...
   * button to the comunication layer to comunicate with the client
